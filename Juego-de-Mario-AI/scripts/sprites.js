...
function MarioAnimation(){
  mario=createSprite(gameConfig.startingPointX, gameConfig.startingPointY, gameConfig.startingPoint, 0.30);
  mario.addAnimation("stand",'dou.png');
  mario.addAnimation("move",'dou.png');
  mario.addAnimation("crouch",'dou.png');
  mario.addAnimation("jump",'dou.png');
  mario.addAnimation("dead",'dou.png');
};
